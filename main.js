...
function MeTi_generator(){
	...
	descTable.innerHTML = '<table class="table">'+
		...
		'<tr>'+
		'<th scope="row">5</th>'+
		'<td><textarea name="" id="" cols="10" rows="3" class="form-control">Top '+store.value+' Discount: '+off.value+' Cash Back on Top Deals Products. More than 50 Coupons & Free Shipping Promo Codes for '+month.value+'-'+year+'. Save Even More with Berry Deals. Never Miss The Big Savings. </textarea></td>'+
		'</tr>'+
		'<tr>'+
		'<th scope="row">6</th>'+
		...
		'<tr>'+
		'<th scope="row">7</th>'+
		'<td><textarea name="" id="" cols="10" rows="3" class="form-control">Today\'s top '+store.value+' offer: Up to '+off.value+' Off '+store.value+' Promo Codes & Coupons | '+month.value+'-'+year+' + Free Shipping. Save with '+store.value+' promotions at Berry Deals. Check Uut Other Promo Codes and Discount Codes for More Offers.</textarea></td>'+
		'</tr>'+
		'<tr>'+
		'<th scope="row">8</th>'+
		...
		'<tr>'+
		'<th scope="row">9</th>'+
		'<td><textarea name="" id="" cols="10" rows="3" class="form-control">Save with '+store.value+' Coupons & Promo Codes for '+month.value+'-'+year+'. Find Verified Coupons & Offers for '+store.value+' on Berry Deals. Apply These Coupons & Promo Codes for Extra Benefit.</textarea></td>'+
		'</tr>'+
		'</tbody>'+
		'</table>';
